import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"前端/electron/5.基础知识.md","filePath":"前端/electron/5.基础知识.md","lastUpdated":1719473147000}'),e={name:"前端/electron/5.基础知识.md"},t=p(`<h2 id="国内镜像" tabindex="-1">国内镜像 <a href="#国内镜像"></a> <a class="header-anchor" href="#国内镜像" aria-label="Permalink to &quot;国内镜像 [](#国内镜像)&quot;">​</a></h2><p>将Electron设置国内镜像后，可以加快文件的下载速度，需要设置 electron_mirror 与 electron_builder_binaries_mirror 镜像，下面是 electron的国内镜像设置。</p><h2 id="pnpm-设置" tabindex="-1">pnpm 设置 <a href="#pnpm-设置"></a> <a class="header-anchor" href="#pnpm-设置" aria-label="Permalink to &quot;pnpm 设置 [](#pnpm-设置)&quot;">​</a></h2><p><strong>electron_mirror</strong></p><div class="language-auto vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">auto</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>pnpm config set electron_mirror=https://npm.taobao.org/mirrors/electron/</span></span>
