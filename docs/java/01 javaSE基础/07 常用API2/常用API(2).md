...
来，打开我们准备好的帮助文档，关于通过帮助文档查看String，大家按照讲解的API的使用步骤看看即可。
...
在这个输入框里，我们要输入一个猜的数据，然后点击我猜这个按钮，和已经产生的数据进行比对，给出相应的提示即可。
...
来，打开我们准备好的帮助文档，关于通过帮助文档查看Date，大家按照讲解的API的使用步骤看看即可。
...
打开我们准备好的帮助文档，关于通过帮助文档查看SimpleDateFormat，大家按照讲解的API的使用步骤看看即可。
